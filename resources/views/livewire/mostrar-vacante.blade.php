<div>
    <div class="p-10">
        ...
        <div class="mb-5">
            ...
            <div class="md:grid md:grid-cols-2 bg-gray-100 p-4 sm:rounded-lg my-10">
                ...
                <p class="font-bold text-sm uppercase text-gray-800 my-3">Último día para postularse:
                    <span class="normal-case font-normal"> {{$vacante->ultimo_dia->translatedFormat('l, j F Y')}} </span>
                </p>
